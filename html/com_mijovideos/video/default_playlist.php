...
?>
<script src="<?php echo JURI::root(); ?>components/com_mijovideos/assets/js/jquery.mousewheel.js" type="text/javascript" ></script>
<script src="<?php echo JURI::root(); ?>components/com_mijovideos/assets/js/perfect-scrollbar.js" type="text/javascript" ></script>
