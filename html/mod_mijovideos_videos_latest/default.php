            ...
            <?php foreach ($rows as $row) {
                ...
                <div class="mijovideos-top-module">
                    <a href="<?php echo $link; ?>">
                        <div id="videos-items-grid-thumb_cp" style="width: <?php echo $width; ?>px; height: <?php echo $height; ?>px">
                            <span class="video_time"><?php echo $utility->secondsToTime($row->duration); ?></span>
                            <?php echo $utility->getWatchLaterButton($row->id); ?>
                        </div>
    ...
    <?php } else { ?>
        <?php foreach ($rows as $row) {
            ...
            <div class="mijovideos-modules-module">
                ...
                <h3 class="mijovideos_box_h3" style="width: <?php echo $width; ?>px;">
